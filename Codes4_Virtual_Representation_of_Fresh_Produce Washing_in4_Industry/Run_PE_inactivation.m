...
clc
    ...
    %%%====================================================================
        ...
        inputs.nlpsol.eSS.maxtime     = 10*60;                                              % Maximum time for optimisation, 
    ...
    baseDir     = pwd;
    results_dir = fullfile(baseDir,'Results/results_inactivation/');
    ...
    if trial==1
        prev_res=load('Pre_optims/YD_cteMonly-LocalKiKm-GlobalAAL_reoptb_Runer0p56_cpu30.mat');
