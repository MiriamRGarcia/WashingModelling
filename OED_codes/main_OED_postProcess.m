...
load('../Results/sec320_OED/data_OED_and_nonOED_exps.mat');

%% 2. Loop over OED and non-OED cases
for ii = 1:2
    % Default: OED case
    fig_name = '../Results/sec320_OED/fig_OED';
    pos_label = [0.5726, 0.5346];

    if ii == 2
        % Non-OED case setup
        fig_name = '../Results/sec320_OED/fig_noOED';
    ...
    if ii == 1
        load('../Results/sec320_OED/data_CorePred.mat');
        fig_name='../Results/sec320_OED/fig_CorePred';
    else
        load('../Results/sec320_OED/data_CorePred_nonOED.mat');
        fig_name='../Results/sec320_OED/fig_CorePred_nonOED';
    end
...
save('../Results/sec320_OED/all_data')