...
if frun == 1
    ...
    load('../Pre_optims/Best_resutls_sec320_OED_with_Eopt.mat','res');
end
...
disp('Saving data in results');
if ~exist('../Results/sec320_OED'); mkdir('../Results/sec320_OED'); end
save('../Results/sec320_OED/data_OED_and_nonOED_exps');
