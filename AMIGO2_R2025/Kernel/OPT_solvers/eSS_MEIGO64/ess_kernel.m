...
% [JRB-Nov-2024] the line above replaced by try...catch to detect
% incomplete Refset
try
    Refset=[Refset; sol(iii(ooo(1:last_members)),:)];
catch exception
    % Display error message
    disp('***Error in Refset, could not find enough feasible solutions');
    disp('***Revise computation of objective function');
    disp('***Entering keyboard mode****');
