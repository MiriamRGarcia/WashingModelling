...
switch inputs.ivpsol.ivpsolver
    ...
    case 'blackboxmodel'
        ...
        [yteor privstruct.iflag]=feval(blackboxmodel_file,inputs.exps.t_in{iexp},inputs.exps.t_f{iexp},privstruct.t_int{iexp},y_0,par,privstruct.u{iexp},inputs.exps.pend{iexp},privstruct.t_con{iexp},iexp,inputs);
